package cc.unitmesh.devins.idea.theme

import androidx.compose.ui.graphics.Color

/**
 * AutoDev Design System - Color Palette for IntelliJ IDEA
 *
 * 完整实现 IdeaAutoDevColors.的颜色系统，保证与 mpp-ui 的 API 一致性
 * 
 * 设计原则：
 * 1. 虚空色阶 (Void) - 带微量蓝色的冷色调背景
 * 2. 能量色阶 (Energy) - 区分用户意图（电光青）与 AI 响应（霓虹紫）
 * 3. 信号色阶 (Signal) - 高饱和度的状态指示色
 * 4. 向后兼容 - 保留所有旧的色阶别名 (c50-c900)
 */
object IdeaAutoDevColors {
    // ========================================================================
    ...
    /**
     * Gray -> 中性灰色阶 (映射到 Neutral)
     */
    object Gray {
        val c50 = Neutral.c50
        val c100 = Neutral.c100
        val c200 = Neutral.c200
        val c300 = Neutral.c300
        val c400 = Neutral.c400
        val c500 = Neutral.c500
        val c600 = Neutral.c600
        val c700 = Neutral.c700
        val c800 = Neutral.c800
        val c900 = Neutral.c900
    }
}
