 ...
 *
 * Note: XiuperFsDatabase.Schema.version is automatically generated by SQLDelight
 * based on the number of .sqm migration files in src/commonMain/sqldelight/.../migrations/
 * Current schema: v2 (base FsNode.sq + 1.sqm migration for FsXattr)
 */
fun createDatabase(driver: SqlDriver): XiuperFsDatabase {
    val currentVersion = getUserVersion(driver)
    // Schema.version is auto-generated by SQLDelight (currently 2: base + 1 migration)
