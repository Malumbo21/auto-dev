...
actual fun WebEditView(
    ...
    LaunchedEffect(Unit) {
        ...
        if (bridge is AndroidWebEditBridge) {
            println("[WebEditView] ✅ Setting up AndroidWebEditBridge callbacks")
            ...
            println("[WebEditView] ⚠️ Bridge is not AndroidWebEditBridge: ${bridge::class.simpleName}")
        }
    }
