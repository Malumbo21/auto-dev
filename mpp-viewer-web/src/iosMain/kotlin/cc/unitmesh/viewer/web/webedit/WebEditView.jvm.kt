...
actual fun WebEditView(
    ...
    LaunchedEffect(Unit) {
        ...
        if (bridge is IosWebEditBridge) {
            println("[WebEditView] ✅ Setting up IosWebEditBridge callbacks")
            ...
            println("[WebEditView] ⚠️ Bridge is not IosWebEditBridge: ${bridge::class.simpleName}")
        }
    }
