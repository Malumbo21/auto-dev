...
/**
 * JS implementation of WebEditVisionHelper.
 * Vision fallback is not available on JS/Web platform (returns null).
 */
actual class WebEditVisionHelper actual constructor(
    ...
    ): Flow<String> = flowOf("[Vision fallback not available on Web]")
    ...
    actual override suspend fun suggestActionsWithVision(
        ...
        // Vision fallback not available on JS/Web
        return emptyList()
    }
}

/**
 * Factory function for JS/Web - returns null as vision is not supported.
 */
