...
/**
 * Android stub implementation of ImageUploader.
...
actual class ImageUploader actual constructor(private val config: CloudStorageConfig) {
    actual suspend fun uploadImage(
        ...
        return ImageUploadResult(
            success = false,
            error = "Image upload is not yet supported on Android. Coming soon!"
        )
    }
...
/**
 * Android stub implementation of VisionAnalysisService.
 */
actual class VisionAnalysisService actual constructor(
    ...
    actual suspend fun analyzeImages(
        ...
        throw UnsupportedOperationException("Vision analysis is not yet supported on Android")
    }
